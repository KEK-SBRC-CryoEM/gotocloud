...
function gtc_rerion_tutorial() {
        ...
        cp /efs/em/relion40_tutorial_precalculated_results.tar.gz /fsx
        tar -xf /fsx/relion30_tutorial_data.tar -C /fsx
        tar -zxf /fsx/relion40_tutorial_precalculated_results.tar.gz -C /fsx
        mv /fsx/relion30_tutorial /fsx/relion40_tutorial
        mv /fsx/relion40_tutorial_precalculated_results/* /fsx/relion40_tutorial
        rm /fsx/relion30_tutorial_data.tar
        rm /fsx/relion40_tutorial_precalculated_results.tar.gz
        rm -r /fsx/relion40_tutorial_precalculated_results/
}

# check if /fsx/relion31_tutorial/ exists.
GTC_RELION_DIR="/fsx/relion40_tutorial/"
