...
# --------------------
# ctffind 4.1.14
export PATH=/efs/em/ctffind-4.1.14-linux64/bin:$PATH

# Gctf-v1.06
export PATH=/efs/em/Gctf_v1.06/bin:$PATH

# relion 3.1.2
export PATH=/efs/em/relion-v31/relion-3.1.2/bin:$PATH
export LD_LIBRARY_PATH=/efs/em/relion-v31/relion-3.1.2/lib:$LD_LIBRARY_PATH
...
export RELION_QSUB_EXTRA1_HELP="Partitions: g4dn-vcpu96-gpu8, g4dn-vcpu48-gpu4*, g4dn-vcpu32-gpu1, c5-vcpu96-gpu0, c5-vcpu96-gpu0-spot"
...
# USFS chimera 1.15
export PATH=/efs/em/UCSF-Chimera64-1.15rc/bin:$PATH
