...
def main():
    ...
    ### 2025/09/19 Example of command line generated by RELION
    ...
    ###     --scheme_copy_source Schemes_Edited/    \
    ###     --link symbolic    \
    ###     --merge_scheme_node 090050_Refine3D_local    \
    ###     --merge_file run_data.star    \
    ###     --j 1 
    ...
    parser.add_argument('-cp', '--scheme_copy_source',  type=str, default=None,  help = 'Path to a directory containing source "Schemes" folder. (default specified in stack_split_scheme.yml).')
    ...
    try:
        ...
        for sub_folder in sub_folder_list:
            ...
            scheme_copy_source_subdir_path = os.path.join(scheme_copy_source, SCHEMES_DIR_NAME)
            print(f'[KEK_DEBUG] SchemeCopySourceSubdirPath: {scheme_copy_source_subdir_path}')
            ms_folder.make_sub_folder(current_path, sub_folder_path, copy_file_list, scheme_copy_source_subdir_path, scheme_list)
