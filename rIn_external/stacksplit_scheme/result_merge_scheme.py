...
def main():
    ...
    try:
        ...
        result_list = get_result_file(setting_data['current_path'], setting_data['sub_folder_name'],
                                      setting_data['node_name'], setting_data['merge_file_name'])
        ...
        mrs_folder.make_result_symboliclink_folder(setting_data['current_path'], setting_data['sub_folder_name'],
                                                   result_list)
