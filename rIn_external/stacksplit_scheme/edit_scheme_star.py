...
def edit_scheme_star_file(star_file, item_string, change_string):
    ...
    if  os.path.exists(star_file):
        ## [Debug] make backup file
        #shutil.copy(target_path, f'{target_path}.back')
...
def edit_scheme_star(current_path, sub_folder_path, split_file):
    ...
    job_name = comm.extract_job_name_from_file(run_out_020, '020020_Select_mics')
    ...
    job_name = comm.extract_job_name_from_file(run_out_010, '010030_Select_mics')
    change_file = os.path.join(job_name, 'micrographs.star')
